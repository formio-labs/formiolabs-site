  ...
  return (
    <div className="space-y-6">
      <h2 className="font-display text-2xl font-semibold tracking-tight text-stone-900 sm:text-3xl">
        {isSuccess ? (
          <>Thanks for reaching out &mdash; We&#39;ll be in touch.</>
        ) : (
          <>Interested in collaborating or learning more?</>
        )}
      </h2>
      {isSuccess ? (
        <div className="rounded-2xl border border-stone-200/80 bg-white px-6 py-6 text-base text-stone-700 shadow-sm">
